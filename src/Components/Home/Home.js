...
return(
    ...
    <main id="Home">
        ...
        <aside>
            ...
            <a className="Icon" href="https://www.youtube.com/@DotDager" target="_blank" rel="noreferrer"><GitHubIcon/></a>
            <a className="Icon" href="https://www.instagram.com/dager.32/" target="_blank" rel="noreferrer"><GitHubIcon/></a>
        </aside>
        </div>
